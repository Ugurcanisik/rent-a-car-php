...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Araç Teslim Talepleri</h1>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php 
                            $kiraarac=mysqli_query($conn,"select * from kiraarac where silindimi='0' and teslim='1'");
                            while ($kiraaracyaz=mysqli_fetch_assoc($kiraarac)) { ?>
                                <tr>
                                    ...
                                    <td style="width: 40px;"><a href="../netting/islem.php?teslimaltalep=<?php echo $kiraaracyaz['kira_id']; ?>"><button class="btn btn-success">Teslim Al</button></td></a>
